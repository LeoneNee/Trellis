...
**Fallback:** If the `office-hours` skill is not available (skill not found error), fall back to inline YC-style questioning:
1. Ask: "What is the status quo? How does the user solve this problem today?"
2. Ask: "What is the narrowest possible wedge? What is the smallest useful version?"
3. Ask: "How will you know if this works? What observation would confirm success?"
4. Capture answers into a design doc at `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md`
5. Continue with Step 3 as normal.
