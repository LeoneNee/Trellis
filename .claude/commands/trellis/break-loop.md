---
description: Deep bug analysis and knowledge capture after debugging
...
2. **Sync templates** - After updating `.trellis/spec/`, sync to `packages/cli/src/templates/markdown/spec/`
