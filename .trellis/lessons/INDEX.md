...
- #config — Configuration, initialization, setup
- #team — Team workflow, onboarding
- #trellis — Trellis framework internals
...
Create a new `.md` file in this directory. Prefix with `NNN-` for sorting.
Link it in the table above.
