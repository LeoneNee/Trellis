...
This project is indexed by GitNexus as **Trellis** (6013 symbols, 9036 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
